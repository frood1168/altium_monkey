...
SPEC_NAME = "rigid_flex_impedance_backdrill"
OUTPUT_DIR = SAMPLE_DIR / "output"
OUTPUT_PCBDOC = OUTPUT_DIR / "pcbdoc_create_rigid_flex_impedance_backdrill.PcbDoc"
OUTPUT_STACKUP = OUTPUT_DIR / "pcbdoc_create_rigid_flex_impedance_backdrill.stackup"
OUTPUT_STACKUPX = OUTPUT_DIR / "pcbdoc_create_rigid_flex_impedance_backdrill.stackupx"
OUTPUT_MANIFEST = OUTPUT_DIR / "rigid_flex_impedance_backdrill_manifest.json"
...
def main() -> None:
    ...
    print("Branches: " + ", ".join(branch["name"] for branch in readback["branches"]))
